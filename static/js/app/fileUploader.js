                ...
                initUploader: function(b) {
                    ...
                    p.options.fileSizeLimit && (x.fileSizeLimit = p.options.fileSizeLimit),
                        ...
                        d.on("uploadSuccess",
                            function(b, c) {
                            console.log(c);
                                return c.result == 0 ? (alert(c.msg), void d.resetUploader()) : void((c.attachment || c.media_id) && (k++, d.uploadedFiles.push(c), a("#" + b.id).append('<span class="success" style="line-height: 50px;">' + c.width + "x" + c.height + "</span>"), a(".accept").text("成功上传 " + k + " " + typeUnit + j)))
                            }),
