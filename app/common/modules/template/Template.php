...
class Template
{
    ...
    private function _getItems()
    {
        $result = [
            ...
            'seller_refund_apply' => [
                'title' => '申请退款/退货/换货申请通知[卖家]',
                'subtitle' => '申请退款/退货/换货申请通知[卖家]',
                'value' => 'seller_refund_apply',
                'param' => [
                    '商城名称'  ,'粉丝昵称' , '退款单号', '退款申请时间' ,'退款类型', '退款金额', '退款方式', '退款原因', '订单编号','商品详情（含规格）'
                ]
            ],
            'order_parent_notice' => [
                'title' => '两级消息通知(后台)',
            ...
            'buyer_refund_apply_success' => [
                ...
                'param' => [
                    '商城名称', '粉丝昵称', '退款单号', '退款申请时间', '退款成功时间', '退款方式', '退款金额', '退款原因','退款成功时间'
                ]
            ],
            'buyer_refund_apply_reject' => [
                'title' => '退款申请驳回通知(买家)',
                'subtitle' => '退款申请驳回通知(买家)',
            ...
            'finance_balance_withdraw_fail' => [
                'title' => '余额提现失败通知(会员)',
                'subtitle' => '余额提现失败通知(会员)',
                'value' => 'finance_balance_withdraw_fail',
                'param' => [
                    '时间', '金额', '手续费', '提现单号'
                ]
            ],
            'finance_balance_withdraw_reject' => [
                'title' => '余额提现驳回通知(会员)',
                'subtitle' => '余额提现驳回通知(会员)',
                'value' => 'finance_balance_withdraw_reject',
                'param' => [
                    '时间', '金额', '手续费'
                ]
            ],
