...
class SmsSetService
{
     ...
     * @return array|bool
     */
    protected function tXYun()
    {
        if ($this->sms_set['tx_sdkappid']
            && $this->sms_set['tx_appkey']
            && $this->sms_set['tx_signname']
            && $this->sms_set['tx_templateCode']
            && $this->sms_set['tx_templateCodeForget']
        ) {
            return [
                'tx_sdkappid' => $this->sms_set['tx_sdkappid'],
                'tx_appkey' => $this->sms_set['tx_appkey'],
                'tx_signname' => $this->sms_set['tx_signname'],
                'tx_templateCode'=> $this->sms_set['tx_templateCode'],
                'tx_templateCodeForget' => $this->sms_set['tx_templateCodeForget'],
            ];
        }
        return false;
    }
