...
class GenerateAddressJs
{
    public function address()
    {
        if (config('app.framework') == 'platform') {
            $file_dir = base_path().DIRECTORY_SEPARATOR.'addons'.DIRECTORY_SEPARATOR.'yun_shop'.DIRECTORY_SEPARATOR.'static';
        } else {
            $file_dir = base_path().DIRECTORY_SEPARATOR.'static';
        }
        ...
        $ccc =  file_put_contents($file_dir.DIRECTORY_SEPARATOR.'gov_province_city_area_id.js', $str);
        return $ccc;
