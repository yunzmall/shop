...
class GoodsDispatch extends \app\common\models\goods\GoodsDispatch
{
    ...
    public static function relationSave($goodsId, $data, $operate)
    {
        ...
        $dispatch_type_ids = implode(',',$data['dispatch_type_ids']);
        if ($dispatch_type_ids) {
            $data['dispatch_type_ids'] = $dispatch_type_ids;
        } else {
            $data['dispatch_type_ids'] = DispatchType::EXPRESS;
        }
