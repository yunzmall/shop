...
@section('content')
    ...
    <div class="page-content">
        <div class="alert alert-success">
            <b>注意：</b>
            <p>小程序公众平台服务类目请添加商家自营 > <b>美妆/洗护</b>，所选行业不一致将会导致模板消息不可用。
            </p>
            <p>当前列表内的模板消息为您已申请的模板消息</p>
        </div>
        ...
        <form action="" method="post">
            ...
            <span class=''>
                 ...
                 <a class='btn btn-info btn-sm' href="{!! yzWebUrl('setting.small-program.synchronization') !!}"><i class="fa fa-plus-square"></i> 同步消息模板</a>
             </span>
                </div>
            </form>
        </form>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <a class="btn btn-info btn-sm disbut"
                                   href="{!! yzWebUrl('setting.small-program.see', array('tmp_id' => $row['priTmplId'])) !!}">查看</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
