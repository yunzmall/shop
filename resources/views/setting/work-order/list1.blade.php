...
<div id="app">
      <template>
            <div class="workOrder" >
            <div class="title"><span style="width: 4px;height: 18px;background-color: #29ba9c;margin-right:15px;display:inline-block;"></span><b>我的工单</b></div>
                  ...
                  <div class="table_box" style="margin-top:20px;">
                        <el-table :data="tableData"  align="center">
                              <el-table-column prop="work_order_sn" label="工单编号" align="center" >
                              </el-table-column>
                              <el-table-column prop="question_title" label="问题标题" align="center">
                              </el-table-column>
                              <el-table-column prop="created_at" label="提交时间" align="center">
                              </el-table-column>
                              <el-table-column prop="completion_time" label="完成时间" align="center">
                              </el-table-column>
                              <el-table-column prop="difference" label="处理时长" align="center">
                              </el-table-column>
                              <el-table-column prop="status_name" label="处理状态" align="center">
                              </el-table-column>
                              <el-table-column prop="has_one_admin_user.name" label="售后人员" align="center">
                              </el-table-column>
