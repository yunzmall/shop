...
<div class="form-group">
    <label class="col-xs-12 col-sm-3 col-md-2 control-label">会员起购数量</label>
    <div class="col-sm-9 col-md-2 col-xs-12">
        <input type="text" name="widgets[privilege][min_buy_limit]" id="widgets[privilege][min_buy_limit]" class="form-control" value="{{ $privilege['min_buy_limit'] }}" />
        <span class='help-block'>会员单次最少购买数量，为空、0不限制</span>
    </div>
</div>
{{--
<div class="form-group">
