...
<div class="form-group">
    ...
    <div class="col-sm-6 col-xs-6">
        <div class='input-group'>
            ...
            <label class="radio-inline">
                <input type="radio" name="widgets[discount][discount_method]" value="3" @if($discount[0]['discount_method'] == '3') checked @endif />
                成本比例
            </label>
        </div>
    </div>
            ...
            <div class="col-sm-6 col-xs-6">
                <div class='input-group col-md-6'>
                    ...
                    <div class='input-group-addon waytxt'>
                        @if (!empty($discount) && $discount[0]['discount_method'] == 1)
                            折
                        @elseif($discount[0]['discount_method'] == 3)
                            %
                        @else
                            元
                        @endif
