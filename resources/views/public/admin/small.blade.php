            ...
            <div class="modal-body tab-content">
                <div role="tabpanel" class="tab-pane link_small_system active" id="link_small_system">
                    <div class="mylink-con">
                        ...
                        <div id="fe-tab-link-li-25" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 25)" data-href="/packageD/member/footprint/footprint">我的足迹</div>
                        ...
                        <div id="fe-tab-link-li-29" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 29)" data-href="/packageD/member/addressList/addressList">收货地址</div>
                        ...
                        <div id="fe-tab-link-li-36" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 36)" data-href="/packageA/member/balance/balance/balance">会员余额</div>
                        ...
                        <div id="fe-tab-link-li-40" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 40)" data-href="/packageB/member/Integral_love/Integral_love">会员积分</div>
                        ...
                        <div id="fe-tab-link-li-50" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 50)" data-href="/packageD/member/addressList/addressList">收货地址</div>
                        <div id="fe-tab-link-li-52" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 52)" data-href="/packageD/member/addressAdd_v2/addressAdd_v2">添加收货地址</div>
                        ...
                        <div id="fe-tab-link-li-54" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 54)" data-href="/packageD/member/footprint/footprint">我的足迹</div>
                        <div id="fe-tab-link-li-55" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 55)" data-href="/packageD/member/collection/collection">我的收藏</div>
                        <div id="fe-tab-link-li-56" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 56)" data-href="/packageD/member/myRelationship/myRelationship">我的关系</div>
                        <div id="fe-tab-link-li-58" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 58)" data-href="/packageD/member/myEvaluation/myEvaluation">我的评价</div>
...
{{--                       <div id="fe-tab-link-li-85" class="btn btn-default mylink-app-nav" ng-click="chooseLink(1, 85)" data-href="/pages/coupon/coupon_store">领券中心</div>--}}
                ...
                <div role="tabpanel" class="tab-pane link_small_cate" id="link_small_cate">
                    <div class="mylink-con" style="height:500px">
                        <div id='treebox1'>
    ...
    require(['jquery'],function(){
        ...
        $(document).on("click",".nav-app-link",function(){
            ...
            if(id){
                ...
                if(category_data1.length<=0) {
                    $.post(category_url1, {}, function (response) {
                        if (response.result == 1) {
                            category_data1 = response.data;
                            tnTreeBox('treebox1','checkboxname1',category_data1,[]);
                        }
