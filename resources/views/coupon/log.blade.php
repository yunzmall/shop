            ...
            <div class="vue-head">
                ...
                <div class="vue-search">
                    <el-form :inline="true" :model="search_form" class="demo-form-inline">
                        ...
                        <el-form-item label="">
                            <el-input v-model="search_form.member_keyword" placeholder="会员ID/昵称/姓名/手机号"></el-input>
                        </el-form-item>

                        <el-form-item label="">
                            <div v-show="show_get_from">
                    ...
                    <el-table :data="list" style="width: 100%">
                        ...
                        <el-table-column label="获取途径" align="center" width="120">
                            <template slot-scope="scope">
                                <span >[[ scope.row.getfrom_name ]]</span>
                            </template>
                        </el-table-column>
            ...
            methods: {
                getData(page) {
                    ...
                    let json = {
                        ...
                        member_keyword:this.search_form.member_keyword,
                ...
                dataExport(){
                    ...
                    if (search_form.member_keyword) {
                        url += "&nickname="+that.search_form.member_keyword;
                        couponDataUrl += "&nickname="+that.search_form.member_keyword;
                    }
                    ...
                    if(this.times && this.times.length>0) {
                        ...
                        couponDataUrl += "&time[start]=" + this.times[0]/1000;
                        couponDataUrl += "&time[end]=" + this.times[1]/1000
                    }
