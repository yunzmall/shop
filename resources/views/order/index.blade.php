                            ...
                            <form  action="" method="get" class="form-horizontal" id="form1">
                                    ...
                                    @section('search_bar')
                                        ...
                                        <div class="form-group  col-md-2 col-sm-6">
                                            <select name="search[ambiguous][field]" id="ambiguous-field"
                                                ...
                                                <option value="member_id"
                                                        @if( array_get($requestSearch,'ambiguous.field','')=='member_id')  selected="selected"@endif>
                                                   会员ID
                                                </option>
                                                ...
                                                <option value="goods_title"{{--order_goods--}}
                                                        @if( array_get($requestSearch,'ambiguous.field','')=='goods_title')  selected="selected"@endif>
                                                    订单商品名称
                                                </option>
                                        ...
                                        <div class="form-group form-group col-sm-8 col-lg-2 col-xs-12">
                                            ...
                                            <select name="search[pay_type]" class="form-control">
                                                ...
                                                <option value="55"
                                                        @if( array_get($requestSearch,'pay_type','') == '55')  selected="selected"@endif>
                                                    微信小程序支付
                                                </option>
                                                <option value="55"
                                                        @if( array_get($requestSearch,'pay_type','') == '54')  selected="selected"@endif>
                                                    确认支付
                                                </option>
                                                <option value="55"
                                                        @if( array_get($requestSearch,'pay_type','') == '17')  selected="selected"@endif>
                                                    货到付款
                                                </option>
                                                <option value="28"
                                                        @if( array_get($requestSearch,'pay_type','') == '28')  selected="selected"@endif>
                                                    汇聚微信（小程序）支付
                                                </option>
                                                <option value="59"
                                                        @if( array_get($requestSearch,'pay_type','') == '59')  selected="selected"@endif>
                                                    汇聚快捷支付
                                                </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7 col-lg-9 col-xs-12">
                                        ...
                                        @endif
{{--                                        <a class="btn btn-warning"--}}
{{--                                           href="{!! yzWebUrl('order.fix.failedJobs') !!}">修复失败队列任务</a>--}}
                                    </div>
                ...
                <table class='table'
                    ...
                    <tr class='trhead'>
                        <td colspan='8' style="text-align: left;">
                            ...
                            运费: <span id="dispatchmoney" style="color:red">{{$dispatch_price}}</span>元
                                    ...
                                    <tr class='trbody'>
                                        ...
                                        @if( $order_goods_index == 0)
                                            <td rowspan="{{count($order['has_many_order_goods'])}}">
                                                ...
                                                <br/>
                                                {{$order['has_many_member_certified']['realname']?:$order['belongs_to_member']['realname']}}
