...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        <div class='form-control-static'>ID: {{$order['belongs_to_member']['uid']}}
            姓名: {{$order['has_many_member_certified']['realname']?:$order['belongs_to_member']['realname']}} /
    ...
    <div class="col-sm-9 col-xs-12">
        <div class="form-control-static">
            <table cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td style='border:none;text-align:right;'>服务费：</td>
                    <td style='border:none;text-align:right;'>
                        ￥{{number_format( $order['service_fee_amount'] ,2)}}</td>
                </tr>
                <tr>
...
@if ($order['pay_time'] !='1970-01-01 08:00:00')
    <div class="form-group">
...
@endif
@if ($order['send_time'] !='1970-01-01 08:00:00')
    <div class="form-group">
...
@endif
@if ($order['send_time'] !='1970-01-01 08:00:00' && $order['finish_time'] != '1970-01-01 08:00:00')
    <div class="form-group">
...
@endif
@if ($order['cancel_time'] !='1970-01-01 08:00:00')
    <div class="form-group">
        <label class="col-xs-12 col-sm-3 col-md-2 control-label">关闭时间 :</label>
        <div class="col-sm-9 col-xs-12">
            <p class="form-control-static">{{$order['cancel_time']}}</p>
        </div>
    </div>
@endif
@if ($order['has_one_expediting_delivery'])
    <div class="form-group">
        <label class="col-xs-12 col-sm-3 col-md-2 control-label">催发货时间 :</label>
        <div class="col-sm-9 col-xs-12">
            <p class="form-control-static">{{$order['has_one_expediting_delivery']['created_at']}}</p>
        </div>
    </div>
@endif
...
@endif
@if(!empty($order['collect_name']) || !empty($order['order_invoice']['collect_name']))
...
@endif
@if (count($order['order_service_fees']))
    <div class="panel panel-default">
        <div class="panel-heading">
            服务费信息
        </div>
        <div class="panel-body table-responsive">
            <table class="table table-hover">
                <thead class="navbar-inner">
                <tr>
                    <th class="col-md-5 col-lg-3">服务费名称</th>
                    <th class="col-md-5 col-lg-3">服务费金额</th>
                </tr>
                </thead>
                @foreach ($order['order_service_fees'] as $orderFee)
                    <tr>
                        <td>{{$orderFee['name']}}</td>
                        <td>¥{{$orderFee['amount']}}</td>
                    </tr>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-sm-9 col-xs-12">
                    <p class="form-control-static">
                        {{ $order['has_many_member_certified']['realname']?:$div_from['member_name'] }}
                    </p>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-9 col-xs-12">
                    <p class="form-control-static">
                        {{ $order['has_many_member_certified']['idcard']?:$div_from['member_card'] }}
                    </p>
                </div>
            </div>
        </div>
