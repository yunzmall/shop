...
<script>
    var app = new Vue({
        ...
        created() {
            ...
            this.$set(this.search_form,'order_sn','{!! $_REQUEST['order_sn']?:'' !!}');
            if (this.getParam('o_status')) {
                this.$set(this.search_form, 'order_status', [this.getParam('o_status')]);
            }
            this.$set(this.search_form,'member_id',this.getParam('member_id'));
            this.$set(this.search_form,'time_field',this.getParam('o_time'));
            this.times = [
