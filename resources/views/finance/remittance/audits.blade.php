    ...
    <div id="app-remittance-audits" xmlns:v-bind="http://www.w3.org/1999/xhtml">
        ...
        <el-table
            ...
            <el-table-column
                    ...
                    label="用户">
                <template slot-scope="scope">
                    <div v-if="scope.row.member == null">
                        会员([[scope.row.remittance_record.order_pay.uid]])已被删除
                    </div>
                    <a v-if="scope.row.member != null" v-bind:href="'{{ yzWebUrl('member.member.detail', array('id' => '')) }}'+[[scope.row.remittance_record.order_pay.uid]]"
