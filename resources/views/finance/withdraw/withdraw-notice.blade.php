...
@if(YunShop::notice()->getNotSend('withdraw.income_withdraw_title'))
    <div class='panel-body'>
        <div class="form-group">
            <label class="col-xs-12 col-sm-3 col-md-2 control-label">提现申请通知(财务)</label>
...
@if(YunShop::notice()->getNotSend('withdraw.income_withdraw_check_title'))
    <div class='panel-body'>
        <div class="form-group">
            <label class="col-xs-12 col-sm-3 col-md-2 control-label">提现审核通知(财务)</label>
            <div class="col-sm-8 col-xs-12">
...
@if(YunShop::notice()->getNotSend('withdraw.income_withdraw_pay_title'))
    <div class='panel-body'>
        <div class="form-group">
            <label class="col-xs-12 col-sm-3 col-md-2 control-label">提现打款通知(财务)</label>
            <div class="col-sm-8 col-xs-12">
...
@if(YunShop::notice()->getNotSend('withdraw.income_withdraw_arrival_title'))
    <div class='panel-body'>
        <div class="form-group">
            <label class="col-xs-12 col-sm-3 col-md-2 control-label">提现到账通知(财务)</label>
            <div class="col-sm-8 col-xs-12">
...
@if(YunShop::notice()->getNotSend('withdraw.income_withdraw_arrival_title'))
    <div class='panel-body'>
        <div class="form-group">
            <label class="col-xs-12 col-sm-3 col-md-2 control-label">提现失败管理员通知(财务)</label>
            <div class="col-sm-8 col-xs-12">
...
<div class="panel-body">
    <div class="form-group">
        <label class="col-xs-12 col-sm-3 col-md-2 control-label">会员提现管理员通知(财务)</label>
        <div class="col-sm-8 col-xs-12">
