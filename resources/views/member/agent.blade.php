                ...
                <div class="panel-body">
                    <table class="table table-hover"   style="overflow:visible;">
                        ...
                        <tr>
                            ...
                            <th style='width:8%;text-align: center;'>客户人数</th>
                            ...
                            <td  style="overflow:visible;">
                                ...
                                <div class="btn-group btn-group-sm" >
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-left" role="menu" style='z-index: 9999'>
                                        ...
                                        <li><a href="{{yzWebUrl('member.member.agent-old', ['id'=>$row['member_id']])}}" title='直推客户'><i class='fa fa-exchange'></i> 直推客户 </a></li>
                                        <li><a href="{{yzWebUrl('member.member.agent', ['id'=>$row['member_id']])}}" title='团队客户'><i class='fa fa-exchange'></i> 团队客户 </a></li>
                                        <li><a href="{{yzWebUrl('member.member.agentParent', ['id'=>$row['member_id']])}}" title='上级会员'><i class='fa fa-exchange'></i> 上级会员 </a></li>
