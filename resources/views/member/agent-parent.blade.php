                            ...
                            <td  style="overflow:visible;">
                                ...
                                <div class="btn-group btn-group-sm" >
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-left" role="menu" style='z-index: 9999'>
                                        ...
                                        <li><a href="{{yzWebUrl('point.recharge.index',['id'=>$row['parent_id']])}}" title='充值积分'><i class='fa fa-credit-card'></i> 充值积分</a></li>
                                        <li><a href="{{yzWebUrl('balance.recharge.index', ['member_id'=>$row['parent_id']])}}" title='充值余额'><i class='fa fa-money'></i> 充值余额 </a></li>
                                        <li><a href="{{yzWebUrl('member.member.agent-old', ['id'=>$row['parent_id']])}}" title='直推客户'><i class='fa fa-exchange'></i> 直推客户 </a></li>
                                        <li><a href="{{yzWebUrl('member.member.agent', ['id'=>$row['parent_id']])}}" title='团队客户'><i class='fa fa-exchange'></i> 团队客户 </a></li>
                                        <li><a href="{{yzWebUrl('member.member.agentParent', ['id'=>$row['parent_id']])}}" title='上级会员'><i class='fa fa-exchange'></i> 上级会员 </a></li>
