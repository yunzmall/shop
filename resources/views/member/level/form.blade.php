    ...
    <div class="rightlist">
                                ...
                                <div class='panel-body'>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-xs-12">
                                            <div class='input-group'>
                                                ...
                                                <div class="input-group multi-img-details" id='goods_id' style="margin-bottom: 50px">
                                                    @foreach ($goods as $k => $good)
                                                        <div class="multi-item saler-item" openid="{{ $goods[$k]['id'] }}">
                                                            ...
                                                            <div class='img-nickname' style="overflow: hidden">【ID: {{$good['id']}}】{{ $good['title'] }}</div>
                                                ...
                                                @if($shopSet['level_type'] == 4)
                                                    <span class='input-group-addon'>一次性充值满</span>
                                                    <input type="text"
                                                           class="form-control"
                                                           name="level[balance_recharge]"
                                                           value="{{ $levelModel->balance_recharge }}"/>
                                                    <span class='input-group-addon'>元</span>
                                                @endif
                                            </div>
                                            <span class='help-block'>
                                                会员升级条件，不填写默认为不自动升级, 设置
                                                <a href="{{ yzWebUrl('setting.shop.member') }}">
                                                    【会员升级依据】
                                                </a>
                                            </span>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">
                                            @if (empty($shopSet['level_discount_calculation']))
                                                折扣
                                            @else
                                                比例
                                            @endif
                                        ...
                                        <div class="col-sm-9 col-xs-12 form-inline">
                                            ...
                                            <span class='help-block'>请输入0~999之间的数字,计算方式以《<a href="{!! yzWebUrl('setting.shop.member') !!}">商城设置--会员--会员等级优惠计算方式</a>》设置为准</span>
                                        </div>
                                    </div>
        ...
        <script language='javascript'>
            ...
            function select_good(o) {
                ...
                html += '<div class="img-nickname" style="overflow: hidden">【ID: '+o.id+'】' + o.title + '</div>';
