                    ...
                    <div class="panel-body">
                        <form action="" method="get" class="form-horizontal" role="form" id="form1">
                            ...
                            <div class="form-group col-xs-6 col-sm-1 col-md-1 col-lg-1">
                                ...
                                <div class="col-sm-1 pull-right" style="margin-right:60px;display: flex;flex-direction: row">
                        ...
                        <tr>
                            ...
                            <td>
                                @if($row['yz_member']['inviter'] == 0)
                                    <span class="label label-default">暂定客户</span>
                                @elseif($row['yz_member']['inviter'] == 1)
                                    <span class="label label-success">锁定关系客户</span>
                                @endif
                            </td>
                                ...
                                <div class="btn-group btn-group-sm" >
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-left" role="menu" style='z-index: 9999'>
                                      ...
                                      <li><a href="{{yzWebUrl('member.member.agent-old', ['id'=>$row['uid']])}}" title='直推客户'><i class='fa fa-exchange'></i> 直推客户 </a></li>
                                        ...
                                        <li><a href="{{yzWebUrl('member.member.agentParent', ['id'=>$row['uid']])}}" title='上级会员'><i class='fa fa-exchange'></i> 上级会员 </a></li>
    ...
    <script language='javascript'>
        $(function () {
            $('#export').click(function(){
                $('#route').val("member.member.do-export");
                $('#form1').submit();
                $('#route').val("member.member.agent-old");
