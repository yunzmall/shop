            ...
            <form id="setform"  action="{{ yzWebUrl('member.member-relation.save') }}" method="post" class="form-horizontal form">
                <div class='panel panel-default'>
                    ...
                    <div class='panel-body'>
                        ...
                        <div class="form-group">
                            <label class="col-xs-12 col-sm-3 col-md-2 control-label">获得推广权益的条件</label>
                            <div class="col-sm-9 col-xs-12">
                            ...
                            <div class="col-sm-9 col-xs-12">
                                ...
                                <label class="radio-inline">
                                    <input type="radio" name="setdata[become]" value="3"
                                           ...
                                           checked="checked" @endif />
                                    与</label>
                                <span class='help-block'><b>[或]</b>满足以下任意条件都可以成为推广员<br><b>[与]</b>满足以下所有条件才可以成为推广员</span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-xs-12 col-sm-3 col-md-2 control-label"></label>
                    ...
                    <!-- END -->
                        ...
                        <div class="form-group">
                            <label class="col-xs-12 col-sm-3 col-md-2 control-label">锁定客户的标准</label>
                            <div class="col-sm-9 col-xs-12">
                        ...
                        <div class="form-group">
                            <label class="col-xs-12 col-sm-3 col-md-2 control-label">是否需要审核才能推广</label>
                            <div class="col-sm-9 col-xs-12">
                                ...
                                <label class="radio-inline"><input type="radio"  name="setdata[become_check]" value="0" @if($set['become_check'] ==0) checked="checked"
                                            @endif /> 不需要</label>
                                <span class="help-block">以上条件达到后，是否需要审核才能推广客户</span>
                            </div>
                        </div>
                        ...
                        <div class='panel-body'>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-xs-12">
                                    <div class="input-group">
                                        <input type="text" name="setting[small_jump_link]" data-id="PAL-00012" class="form-control" placeholder="" value="{{$setting['small_jump_link']}}" />
                                        <span class="input-group-btn">
