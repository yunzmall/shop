        ...
        <div class="setting">
            <el-form ref="form" label-width="15%">
                <div class="block">
                    ...
                    <el-form-item label="开启提现二次校验">
                        <el-switch v-model="is_phone_verify" active-value="1" inactive-value="0" @change="changeSwitch()"></el-switch>
                    </el-form-item>
                    <el-form-item label="提现验证手机号">
                        <span>[[phone]]</span>
                    ...
                    <el-form-item label="验证有效期">
                        ...
                        <div class="tip">
                            提现打款验证成功后，在验证有效期内，无需重复验证，默认10分钟，最长可设置不超过120分钟。
                        </div>
                    </el-form-item>
            ...
            <el-dialog :visible.sync="phone_show" width="450px" center title="设置提现验证手机号">
                <div>
            ...
            <el-dialog :visible.sync="phone_edit" width="450px" center title="修改提现验证手机号">
                <div>
            ...
            <el-dialog :visible.sync="phone_close" width="450px" center title="关闭提现二次校验短信验证">
                <div>
                    <el-form ref="form1" label-width="20%">
                        <el-form-item label="手机号">
                            <span style="display:inline-block;width:60%">[[phone]]</span>
...
<script>
    new Vue({
        ...
        methods: {
            ...
            changeSwitch() {
                if (this.is_set_phone == 1 && this.is_phone_verify == "0") {
